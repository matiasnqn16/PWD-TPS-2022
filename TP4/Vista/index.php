...
<div class="card mb-3 container align-items-center">
  <img src="../util/img/Cronos5-850x555.jpg" class="card-img-top" style="width: 900px;">
  <div class="card-body">
