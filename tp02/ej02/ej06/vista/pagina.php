...
<fieldset> 
    <legend>Selecciona tu nivel de estudios</legend>
...
<div class="form-check mb-3">
    <input type="checkbox" class="form-check-input" id="futbol" name="deporte[]" value="futbol">
    <label class="form-check-label" for="futbol">Futbol</label>
</div>
<div class="form-check mb-3">
    <input type="checkbox" class="form-check-input" id="voley" name="deporte[]" value="voley">
    <label class="form-check-label" for="voley">Voley</label>
</div>
<div class="form-check mb-3">
    <input type="checkbox" class="form-check-input" id="basquet" name="deporte[]" value="basquet">
