...
class BaseDatos extends PDO {
    ...
    /** Funcion que retorna una cadena con descripcion del ultimo error seteado @return */
    public function getError(){
        return "\n".$this->error;
    }
    /** Funcion que retorna una cadena con el ultimo sql seteado @return **/
   ...
   /**Si se inserta en una tabla que tiene una columna autoincrement se retorna el id con el que se inserto el registro caso contrario se retorna -1  */
